...
class TestSmokeTest():
  ...
  def test_homePageTest(self):
    self.driver.get("http://127.0.0.1:3000/teton/1.6/index.html")
  ...
  def test_adminPageTest(self):
    self.driver.get("http://127.0.0.1:3000/teton/1.6/admin.html")
    self.driver.set_window_size(1280, 672)
    elements = self.driver.find_elements(By.ID, "username")
    assert len(elements) > 0
    self.driver.find_element(By.ID, "username").send_keys("uche")
  ...
  def test_directoryPageTest(self):
    self.driver.get("http://127.0.0.1:3000/teton/1.6/directory.html")
    self.driver.set_window_size(1280, 672)
  ...
  def test_joinPageTest(self):
    self.driver.get("http://127.0.0.1:3000/teton/1.6/join.html")
    self.driver.set_window_size(1280, 672)
    elements = self.driver.find_elements(By.NAME, "fname")
    assert len(elements) > 0
    self.driver.find_element(By.NAME, "fname").send_keys("Uchenna")
    self.driver.find_element(By.NAME, "lname").send_keys("Onuorah")
    self.driver.find_element(By.NAME, "bizname").send_keys("Telco")
